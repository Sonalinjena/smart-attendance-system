...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'sonalin8763@gmail.com' ")
...
def TrackImages():
    ...
    while True:
        ...
        my_time="23:00"
        given_time=datetime.datetime.strptime(my_time,"%H:%M")
        if current_time > datetime.datetime.strftime(given_time,"%H:%M"):
            speak("sorry! your attendance can't be taken.next  time,try to come in time")
            break
        ret, im = cam.read()
...
message3 = tk.Label(window, text="Udayanath Auto College of Sc And Tech Adaspur" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
image_path="E:/image/twinkle/unclogo.jpg"
img=Image.open(image_path)
img=img.resize((50,50),Image.LANCZOS)
img=ImageTk.PhotoImage(img)
image_label=tk.Label(frame2,image=img,bg="#c79cff")
image_label.image=img
image_label.place(x=7,y=480)
